...
public class AssetLoader : MonoBehaviour
{
    ...
    void loadDependency()
    {
        ...
        AsyncOperationHandle handle = Addressables.DownloadDependenciesAsync(AddressNameStr);
    ...
    private void loadAssets()
    {
        ...
        if (_isScene)
        {
            AsyncOperationHandle<SceneInstance> task =  Addressables.LoadSceneAsync(AddressNameStr, LoadSceneMode.Additive, true);
            task.Completed += (si) =>
            {
                Debug.Log(AddressNameStr + " load completed");
            };
        }
        else
        {
